...
@Library("github.com/opspresso/jenkinsfiles")
...
podTemplate(label: label, containers: [
  containerTemplate(name: "builder", image: "opspresso/builder:v0.7.69-kube", command: "cat", ttyEnabled: true, alwaysPullImage: true),
